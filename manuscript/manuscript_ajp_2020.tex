...
frogs communicate by croaking patterns modulated by location \cite{Aihara2014},
...
synchronization is phase-locking,
...
%multiple particle oscillators
[Fireflies and pulsed LED].

Dynamical mode locking 
has many important
technological applications
and is often studied with simplified computational models.
These studies can be performed
with coupled oscillators \cite{Kuramoto193?}
or with a single particle driven across a periodic potential landscape \cite{}.
...
i.e. two superconductors sandwiching an insulating layer.
...
Known as Shapiro steps \cite{Shapiro1963},
these indicators of phase locking 
have been observed broadly in a variety of systems
either in 
...
which can be probed with applied AC forces.
...
of mode-locking in colloids interacting via magnetic dipole
...
%American Journal of Physics 77, 1066 (2009); https://doi.org/10.1119/1.3119175
