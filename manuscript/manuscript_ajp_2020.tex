...
driven particles.
Christiaan Huygens 1665 observation of
...
from fireflies signaling in time with a with a pulsed LED \cite{},
...
We summarize unit units of our simulated variables in Table ~\ref{tab:1}.
...
velocity &  \\
force & $E_0 / a_0$\\
electric potential & V(r_{ij} = q^2 E_0/r_{ij}), $E_0 = Z^*^2/()4\pi \epsilon \epsilon_0 a_0$ \\
charge/dimensionless interaction strength $q$ \\
