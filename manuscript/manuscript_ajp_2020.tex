...
forward and backward in the landscape.
  ...
  and semiminor axis of $\Delta \dot{\phi} = 2\pi/\lambda v_{max}$.
  [insert analysis.]
...
%\item
  ...
  In Ref.\cite{Juniper2015} the following
  combinations of forward and backwards steps where realized:
  ...
  We show the results for increasing
  the amplitude of $F^{ac} = 0.2, 0.3, 0.4$.
  %of the system for our original parameters.
  Here the number of backwards steps
  $n_b$ increases from $n_b = 0$ in (a) to
  ...
  we show two additional sweeps of $F^{dc}$.
  In Fig.~\ref{fig:shapiro}(a) $F^{ac}= 0.0$.
  ...
  In Fig.~\ref{fig:shapiro}(b) $F^{ac}=0.4$ and frequency $f=0.01$.
  Mode-locked steps in $\langle v_y \rangle$ vs. $F^{dc}$
  ...
  Between $0.3< F^{dc}<0.5$ the system exhibits phase locked steps.
    ...
    \begin{figure}[h!]
      ...
      \caption{
        ...
        $F^{ac}=0.0$ (blue) and $0.4$ (orange) with frequency $f=0.01$.
      }
      \label{fig:shapiro}
    \end{figure}
  \end{center}
