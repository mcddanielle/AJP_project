...
motions of 
pendula in two wall-mounted clocks.
...
In Huygens clocks, 
the pendula were observed swing at same rate in a 1:1 mode.
For simple pendula of different lengths,
a 2:1 mode can be seen when a pendulum four
times the length of the other swings with twice the period.
%
...
the radiation pressure either moves colloids toward the local minimum 
