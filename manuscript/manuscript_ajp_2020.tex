...
\item{\bf Equation of Motion}
  ...
  {\it this isn't very challenging, but I've see undergraduate students have a ``wow'' factor when they work this out for the first time.}
  ...
  Generally molecular dynamics algorithms
...
\item {\bf Visualizing the motion}
  Drawing the contour 
...
\bibitem{asce}
  What is the method for citing non-fundamental constants?
    (1) https://ascelibrary.org/doi/pdf/10.1061/9780784408230.ap02
    (2) IAPWS 2008 - http://www.iapws.org/relguide/viscosity.html
