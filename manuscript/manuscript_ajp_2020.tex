...
%%HMMM... HAVE YOU INTRODUCED A PHASE SHIFT?
...
%CHECK!!! I THINK THIS IS WRONG!!!
%BY NOT INCLUDING THE SIGN YOU'VE DEFINED IT BACKWARDS!!!!!
%AND LOCATED THE INITIAL POSITION OF THE PARTICLE
%AT A LOCAL MAXIMA!!!!!
%The substrate maxima are located at integer multiples of $y/\lambda = 0, 1, 2 $ 
%and
minima are located at integer multiples $y/\lambda = 1/2, 3/2, 5/2, $ {\it et cetera}.
%This is apparent in the spacing of $y/\lambda$ in time,
%where the visual gaps between positions in Fig.~\ref{fig:0}(b) 
%at half integer multiples $y/\lambda = 1/2, 3/2, 5/2$ indicate regions the particle was moving slowly.
%measure/plot velocity?
