...
in many biological systems with periodic behavior,
from fireflies signaling in time with a pulsed light emitting diode \cite{},
...
Either coupled oscillators or a single particle on a corrugated
potential with an applied AC drive.
