...
\item {\bf Drag Models and Reynolds Numbers}
  ...
  %Likewise
  To first order $\eta \sim 10^{-3}$ Pa-s 
  since 
  ...
  Likewise the liquid density $\rho$ varies with temperature
...
\item{\bf Equation of Motion}
  ...
  In Newton's second law this would be proportional
  ...
  \begin{equation}
    y(t_n \pm \Delta t) = y(t_n) \pm \frac{dy}{dt} \Delta t + \frac{1}{2} \frac{d^2y}{dt^2} (\Delta t)^2 \pm O(\Delta t)^3 ... %\frac{1}{6} \frac{d^3y}{dt^3} (\Delta t)^3 + ...
  \end{equation}
