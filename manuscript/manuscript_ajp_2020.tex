...
\caption{
  ...
  is calculated due to the gradient of the potential
  energy 
  $\vec{F}^l = -\nabla U(\vec{r})$.
  (b) The potential energy function
  along the y-axis $U_l(y)$
  with period $\lambda = L/N_p$
  where the number of periods is $N_p = 3$.
  }
...
We show a schematic of the system in Fig.~\ref{fig:0}
