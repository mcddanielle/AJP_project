...
\caption{Simulation units and approximate values
  in experiment ~\cite{Juniper2015}.
...
interesting patterns \cite{Bak1986}.
...
[Insert Phase Plots section/figure?]
...
\item {\bf Drag Models and Reynolds Numbers}
  ...
  [{\it could certainly do more with this question to make it more computational.  For instance, plot $R$ as a function of any of the parameters $v$, $D$ and $\rho$, include a temperature dependent $\eta(T)$ in the Brownian system.  Suggest students model something big and include inertia and quadratic drag, but then we're fairly off topic...}]
