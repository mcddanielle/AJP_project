...
%  \label{ex:phase}
  ...
  \begin{equation}
    %(y mod \lambda) / \lambda
    \phi(t) = (y(t)-\langle v_y \rangle t)/\lambda
  \end{equation}
  ...
  For clarity we have dropped a prefactor of $2\pi$ 
  ...
  \begin{equation}
    %(y mod \lambda) / \lambda
    \dot{\phi}(t) =(v_y(t)-\langle v_y \rangle) /\lambda.  % 2\pi
  \end{equation}
  ...
  all cases exhibit some line thickening, 
  ...
  $F^{dc} = 0.04$
  the phase plot is a small closed oval
  centered at
  $(\phi,\dot{\phi})=(0.1,0)$.
  A small tail appears
  ...
  three nodes form as the particle moves across $3\lambda$.
    \begin{figure} %[h!]
      ...
      %\vspace*{-3cm}
      \caption{
        Phase plot of a particle with $F^{dc} = $ (a) $0.04$, (b) $0.07$, (c) $0.1$, (d) $0.125$.  These values are marked as black circles
