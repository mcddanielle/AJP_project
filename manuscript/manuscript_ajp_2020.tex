...
A colloid centered in the trap is %subject to a
...
%as shown
  ...
  When $v_y$ %a particle velocity
  is mode-locked to %repeat periodically
  a spatial location
  a closed loop appears in  
  $v_y$ vs $y$ space. % showing the relationship
  ...
  \end{equation}
  centered about the average particle velocity $\bar{v}_y$
  ...
  are asymmetric,
  with nodes in the positive $\dot{\phi}$ values.
  [insert analysis.]
  As the substrate
