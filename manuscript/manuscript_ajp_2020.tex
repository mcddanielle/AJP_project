...
\subsection{Phase plots}
  ...
  a closed loop in  
  parametric phase space % showing the relationship
  ...
  In driven systems,
  the y-position is monotonically increasing.
  We are most interested in the position of the particle
  ...
  %Juniper so-called ‘phase portraits’, in which the phase velocity, d\phi(t)/dt,is plotted against the phase, \phi(t) = 2\pi (x(t)-\bar{v}t)/\lambda (ref. 53). The
  %REF 53
  ...
  \begin{center}
    \begin{figure}[h!]
      ...
      \caption{
        Phase plot of a particle with the same values of $F^{dc}$ and frequency as Fig.~\ref{fig:0}.
      }
      \label{fig:phase}
    \end{figure}
  \end{center}
