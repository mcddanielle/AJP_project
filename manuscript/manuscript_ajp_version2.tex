...
and $U_0$ is a parameter
 ...
 %[DM - switch from red/blue to white/gray - xx make sure that all your figures make sense when printed in b/w xx]
...
Schematic of the simulation of a single particle
  ...
  maxima in the potential energy marked in white %#red
