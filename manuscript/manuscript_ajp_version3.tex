...
%DM ended paragraph with fewer examples, added transition sentence
...
of mode-locked synchronization
can help provide insights to a diverse range of 
oscillation phenomena.

%DM better main topic
Experiments with colloids
...
%new topic - DM this sentence appeared toward the end of the intro
The model discussed in this paper
resembles a damped driven pendulum 
where external forces
add or remove energy from the system.
A single pendulum is driven by
the external force of gravity to return
to an equilibrium position,
and may be damped to decreasing amplitude
by mechanical friction or air resistance.
Multiple pendula may swing in phase
